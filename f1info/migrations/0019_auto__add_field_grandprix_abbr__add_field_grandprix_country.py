...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GrandPrix.abbr'
        db.add_column('f1info_grandprix', 'abbr', self.gf('django.db.models.fields.CharField')(default='', max_length=3, blank=True))

        # Adding field 'GrandPrix.country'
        db.add_column('f1info_grandprix', 'country', self.gf('django.db.models.fields.related.ForeignKey')(related_name='grandprixs', blank=True, null=True, to=orm['f1info.Country']))
    
    
    def backwards(self, orm):
        
        # Deleting field 'GrandPrix.abbr'
        db.delete_column('f1info_grandprix', 'abbr')

        # Deleting field 'GrandPrix.country'
        db.delete_column('f1info_grandprix', 'country_id')
