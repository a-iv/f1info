...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Heat.half_points'
        db.add_column('f1info_heat', 'half_points', orm['f1info.heat:half_points'])
        
        # Deleting field 'Result.half_points'
        db.delete_column('f1info_result', 'half_points')
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Heat.half_points'
        db.delete_column('f1info_heat', 'half_points')
        
        # Adding field 'Result.half_points'
        db.add_column('f1info_result', 'half_points', orm['f1info.result:half_points'])
