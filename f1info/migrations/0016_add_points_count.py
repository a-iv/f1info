...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Result._points_count'
        db.add_column('f1info_result', '_points_count', orm['f1info.result:_points_count'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Result._points_count'
        db.delete_column('f1info_result', '_points_count')
