...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'TrackLen'
        db.create_table('f1info_tracklen', (
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('length', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('f1info', ['TrackLen'])

        # Deleting field 'Track.photo'
        db.delete_column('f1info_track', 'photo')

        # Renaming column for 'Track.length' to match new field type.
        db.rename_column('f1info_track', 'length', 'length_id')
        # Changing field 'Track.length'
        db.alter_column('f1info_track', 'length_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['f1info.TrackLen'], blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting model 'TrackLen'
        db.delete_table('f1info_tracklen')

        # Adding field 'Track.photo'
        db.add_column('f1info_track', 'photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True))

        # Renaming column for 'Track.length' to match new field type.
        db.rename_column('f1info_track', 'length_id', 'length')
        # Changing field 'Track.length'
        db.alter_column('f1info_track', 'length', self.gf('django.db.models.fields.IntegerField')(blank=True))
    ...
    models = {
        ...
        'f1info.grandprix': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'unique': 'True', 'db_index': 'True'}),
            'track': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'tracks'", 'blank': 'True', 'null': 'True', 'to': "orm['f1info.Track']"})
        },
        'f1info.heat': {
        ...
        'f1info.track': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'length': ('django.db.models.fields.related.ForeignKey', [], {'default': '0', 'to': "orm['f1info.TrackLen']", 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'unique': 'True', 'db_index': 'True'})
        },
        'f1info.tracklen': {
