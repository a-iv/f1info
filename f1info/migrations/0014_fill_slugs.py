...
class Migration:
    ...
    def forwards(self, orm):
        ...
        for object in orm.Heat.objects.all():
            object.slug = object.id
            object.save()
        for object in orm.Engine.objects.all():
            object.slug = object.id
            object.save()
        for object in orm.GrandPrix.objects.all():
            object.slug = object.id
            object.save()
        for object in orm.Team.objects.all():
            object.slug = object.id
            object.save()
        for object in orm.Tyre.objects.all():
            object.slug = object.id
            object.save()
        for object in orm.Racer.objects.all():
            object.slug = object.id
            object.save()
