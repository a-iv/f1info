...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('f1info_track', 'track')

        # Adding field 'Track.name'
        db.add_column('f1info_track', 'name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True))
    
    
    def backwards(self, orm):
        
        # Adding field 'Track.track'
        db.add_column('f1info_track', 'track', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True))

        # Deleting field 'Track.name'
        db.delete_column('f1info_track', 'name')
