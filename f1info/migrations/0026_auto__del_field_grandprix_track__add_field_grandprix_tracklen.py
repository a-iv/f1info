...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'GrandPrix.tracklen'
        db.add_column('f1info_grandprix', 'tracklen', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tracks', blank=True, null=True, to=orm['f1info.TrackLen']))
    
    
    def backwards(self, orm):
        
        # Adding field 'GrandPrix.track'
        db.add_column('f1info_grandprix', 'track', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tracks', null=True, to=orm['f1info.Track'], blank=True))

        # Deleting field 'GrandPrix.tracklen'
        db.delete_column('f1info_grandprix', 'tracklen_id')
