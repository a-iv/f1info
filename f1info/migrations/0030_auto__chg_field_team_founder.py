...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Team.founder'
        db.alter_column('f1info_team', 'founder', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Team.founder'
        db.alter_column('f1info_team', 'founder', self.gf('django.db.models.fields.CharField')(max_length=100))
