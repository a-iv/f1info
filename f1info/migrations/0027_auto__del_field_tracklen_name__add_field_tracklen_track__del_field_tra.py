...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TrackLen.track'
        db.add_column('f1info_tracklen', 'track', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['f1info.Track'], null=True))

        # Deleting field 'Track.length'
        db.delete_column('f1info_track', 'length')
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'TrackLen.track'
        db.delete_column('f1info_tracklen', 'track_id')

        # Adding field 'Track.length'
        db.add_column('f1info_track', 'length', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True))
