...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Racer.en_name'
        db.add_column('f1info_racer', 'en_name', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Racer.en_name'
        db.delete_column('f1info_racer', 'en_name')
