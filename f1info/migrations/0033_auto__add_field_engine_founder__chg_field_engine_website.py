...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Engine.founder'
        db.add_column('f1info_engine', 'founder', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'Engine.website'
        db.alter_column('f1info_engine', 'website', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Deleting field 'Engine.founder'
        db.delete_column('f1info_engine', 'founder')

        # Changing field 'Engine.website'
        db.alter_column('f1info_engine', 'website', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))
