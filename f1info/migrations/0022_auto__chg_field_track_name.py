...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('f1info_track', 'name', self.gf('django.db.models.fields.CharField')(max_length=100))
    
    
    def backwards(self, orm):
        
        # Changing field 'Track.name'
        db.alter_column('f1info_track', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))
