...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Racer.website'
        db.alter_column('f1info_racer', 'website', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Racer.website'
        db.alter_column('f1info_racer', 'website', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))
