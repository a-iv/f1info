...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'TrackLen.name'
        db.add_column('f1info_tracklen', 'name', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['f1info.Track'], max_length=100, null=True, blank=True))

        # Deleting field 'Track.length'
        db.delete_column('f1info_track', 'length_id')
    
    
    def backwards(self, orm):
        
        # Deleting field 'TrackLen.name'
        db.delete_column('f1info_tracklen', 'name_id')

        # Adding field 'Track.length'
        db.add_column('f1info_track', 'length', self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['f1info.TrackLen'], blank=True))
    ...
    models = {
        ...
        'f1info.tracklen': {
            ...
            'name': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['f1info.Track']", 'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'})
        },
        'f1info.tyre': {
