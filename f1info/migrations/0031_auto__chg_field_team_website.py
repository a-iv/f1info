...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Team.website'
        db.alter_column('f1info_team', 'website', self.gf('django.db.models.fields.CharField')(max_length=200, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Team.website'
        db.alter_column('f1info_team', 'website', self.gf('django.db.models.fields.CharField')(max_length=200, blank=True))
    ...
    models = {
        ...
        'f1info.team': {
            ...
            'founder': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '100'}),
            'slug': ('django.db.models.fields.SlugField', [], {'max_length': '100', 'unique': 'True', 'db_index': 'True'}),
            'website': ('django.db.models.fields.CharField', [], {'max_length': '200', 'null': 'True', 'blank': 'True'})
