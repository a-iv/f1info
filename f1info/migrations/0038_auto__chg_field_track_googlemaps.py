...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Track.googlemaps'
        db.alter_column('f1info_track', 'googlemaps', self.gf('django.db.models.fields.CharField')(max_length=300, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Track.googlemaps'
        db.alter_column('f1info_track', 'googlemaps', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))
