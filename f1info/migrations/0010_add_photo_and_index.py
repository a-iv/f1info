...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Racer.photo'
        db.add_column('f1info_racer', 'photo', orm['f1info.racer:photo'])
        
        # Adding field 'GrandPrix.index'
        db.add_column('f1info_grandprix', 'index', orm['f1info.grandprix:index'])
        
        # Changing field 'Racer.comment'
        # (to signature: django.db.models.fields.CharField(max_length=200, blank=True))
        db.alter_column('f1info_racer', 'comment', orm['f1info.racer:comment'])
        
    
    
    def backwards(self, orm):
        
        # Deleting field 'Racer.photo'
        db.delete_column('f1info_racer', 'photo')
        
        # Deleting field 'GrandPrix.index'
        db.delete_column('f1info_grandprix', 'index')
