...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Racer.birthday'
        db.alter_column('f1info_racer', 'birthday', self.gf('django.db.models.fields.DateField')(null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Racer.birthday'
        db.alter_column('f1info_racer', 'birthday', self.gf('django.db.models.fields.DateField')())
