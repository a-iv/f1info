...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Track'
        db.create_table('f1info_track', (
            ('track', self.gf('django.db.models.fields.CharField')(default='', max_length=100, blank=True)),
            ('photo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True)),
            ('length', self.gf('django.db.models.fields.IntegerField')(default=0, blank=True)),
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(default='', max_length=100, unique=True, db_index=True)),
        ))
        db.send_create_signal('f1info', ['Track'])

        # Adding field 'GrandPrix.track'
        db.add_column('f1info_grandprix', 'track', self.gf('django.db.models.fields.related.ForeignKey')(related_name='tracks', blank=True, null=True, to=orm['f1info.Track']))
    
    
    def backwards(self, orm):
        
        # Deleting model 'Track'
        db.delete_table('f1info_track')

        # Deleting field 'GrandPrix.track'
        db.delete_column('f1info_grandprix', 'track_id')
    ...
    models = {
        ...
        'f1info.track': {
            ...
            'photo': ('django.db.models.fields.files.ImageField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
            'slug': ('django.db.models.fields.SlugField', [], {'default': "''", 'max_length': '100', 'unique': 'True', 'db_index': 'True'}),
            'track': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '100', 'blank': 'True'})
        },
        'f1info.tyre': {
