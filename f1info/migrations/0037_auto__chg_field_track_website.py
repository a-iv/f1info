...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Track.website'
        db.alter_column('f1info_track', 'website', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True))
    
    
    def backwards(self, orm):
        
        # Changing field 'Track.website'
        db.alter_column('f1info_track', 'website', self.gf('django.db.models.fields.CharField')(max_length=100, blank=True))
