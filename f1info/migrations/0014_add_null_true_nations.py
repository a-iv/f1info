...
class Migration:
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Racer.nation_name'
        # (to signature: django.db.models.fields.related.ForeignKey(blank=True, null=True, to=orm['f1info.Nation']))
        db.alter_column('f1info_racer', 'nation_name_id', orm['f1info.racer:nation_name'])
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Racer.nation_name'
        # (to signature: django.db.models.fields.related.ForeignKey(to=orm['f1info.Nation']))
        db.alter_column('f1info_racer', 'nation_name_id', orm['f1info.racer:nation_name'])
